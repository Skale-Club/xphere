#!/usr/bin/env node
// One-shot applier for migration 1056_contact_identity_audit.sql via pg client (pooler-safe).
...
const MIGRATION_PATH = "supabase/migrations/1056_contact_identity_audit.sql";
const MIGRATION_VERSION = "1056";
const MIGRATION_NAME = "contact_identity_audit";
