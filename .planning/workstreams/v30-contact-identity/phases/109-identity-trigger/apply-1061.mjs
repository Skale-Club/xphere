#!/usr/bin/env node
// One-shot applier for migration 1061_contact_identity_trigger.sql via pg client (pooler-safe).
...
const MIGRATION_PATH = "supabase/migrations/1061_contact_identity_trigger.sql";
const MIGRATION_VERSION = "1061";
const MIGRATION_NAME = "contact_identity_trigger";
