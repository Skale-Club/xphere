#!/usr/bin/env node
// One-shot applier for migration 1060_contact_channel_identities.sql via pg client (pooler-safe).
...
const MIGRATION_PATH = "supabase/migrations/1060_contact_channel_identities.sql";
const MIGRATION_VERSION = "1060";
const MIGRATION_NAME = "contact_channel_identities";
