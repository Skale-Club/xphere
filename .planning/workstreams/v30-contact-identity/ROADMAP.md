...
**Plans:** 5 plans
- [ ] 107-01-PLAN.md — Author migration 1058 (partial UNIQUE indexes + audit guard) and apply to prod via apply-1058.mjs
- [ ] 107-02-PLAN.md — Add findByPhone/findByEmail helpers + refactor createContact for race-safe ON CONFLICT recovery (returns matched_via)
