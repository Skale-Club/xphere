...
- [ ] 108-05-PLAN.md — Race test (UNIQUE/CASCADE/merged_into chain/idempotency) + 108-VALIDATION-REPORT.md with all 7 ROADMAP criteria mapped (D-02 correction on #5)
