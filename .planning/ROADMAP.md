...
**Plans**: 4 plans
- [x] 35-01-PLAN.md — Migration 043: conversations.agent_id ADD COLUMN + backfill + types update + DB push (GATE-01, GATE-07 closed)
...
| 35. Web Widget Canary Cutover | v2.0 | 1/4 | Executing   | - |
