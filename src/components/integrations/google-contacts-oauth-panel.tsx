...
import { connectGoogleContacts } from '@/app/(dashboard)/integrations/google-contacts/actions'
import type { CustomPanelProps } from '@/lib/integrations/registry'

export function GoogleContactsOAuthPanel({ definition, existing }: CustomPanelProps) {
