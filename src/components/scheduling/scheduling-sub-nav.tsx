...
const GOOGLE_CALENDAR_HREF = '/api/google/calendar-oauth'
...
export function SchedulingSubNav() {
  ...
  return (
    <nav className="flex min-h-0 flex-1 flex-col gap-4 overflow-y-auto px-2 py-3">
      ...
      {/* Connect Google Calendar — full page navigation (OAuth redirect) */}
      <div>
        <div className="mb-1 px-2 text-[10.5px] font-semibold uppercase tracking-wider text-text-tertiary">
          Integrations
        </div>
        <div className="flex flex-col gap-px">
          ...
          >
            ...
            <span className="truncate font-medium">Connect Google Calendar</span>
          </a>
        </div>
      </div>
    </nav>
