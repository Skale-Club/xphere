    ...
    <div className="flex flex-row flex-nowrap items-center gap-1.5 sm:gap-2 px-4 sm:px-6 lg:px-8 pt-6 pb-6">
      ...
      <div className="sm:hidden flex items-center gap-1.5">
        ...
        <Button
          ...
          className={cn(
            "h-8 px-2.5 shrink-0 text-[12.5px]",
            calendarOpen && "border-accent/40 bg-accent-muted/20 text-accent",
          )}
...
function TaskFilterPopover({
  ...
  const setFilter = <K extends keyof TaskQuickFilters>(
    key: K,
    next: TaskQuickFilters[K],
  ) => {
