...
const SECTIONS: NavSection[] = [
  {
    heading: null,
    items: [
      { href: '/calendar', label: 'Event Types', icon: CalendarDays, exact: true },
      { href: '/calendar/bookings', label: 'Bookings', icon: BookOpen },
      { href: '/calendar/calendar', label: 'Calendar', icon: CalendarCheck2 },
    ],
  },
  {
    heading: 'Settings',
    items: [
      ...
      { href: '/calendar/preferences', label: 'Preferences', icon: Settings2 },
