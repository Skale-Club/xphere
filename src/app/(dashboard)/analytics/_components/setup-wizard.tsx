...
import { saveAnalyticsSetup } from '../actions'
...
export function SetupWizard({ setup }: Props) {
  ...
  const scriptSrc = `https://xphere.app/api/analytics/script?t=${setup.script_token}`
  ...
  return (
    <div className="mx-auto w-full max-w-2xl px-4 sm:px-6 lg:px-8 py-8 space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-lg font-semibold text-text-primary">Set up Analytics tracking</h1>
