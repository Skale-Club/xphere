...
import { getAnalyticsOverview } from './_actions/get-analytics-overview'
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 rounded-lg border border-border bg-bg-secondary overflow-x-auto">
          <div className="px-4 py-3 border-b border-border flex items-center gap-2">
            ...
            <h2 className="text-[13px] font-semibold text-text-primary">Top Orgs by Sessions</h2>
            <span className="text-[11px] text-text-tertiary ml-auto">Last 30 days</span>
          </div>
          {data.top_orgs.length === 0 ? (
            <div className="px-4 py-8 text-center text-[12.5px] text-text-tertiary">No analytics data yet</div>
          ) : (
  ...
  return (
    <div className="p-4 sm:p-6">
      <div className="mb-6">
        ...
        <p className="text-sm text-text-secondary mt-1">Platform-wide analytics across all organizations</p>
      </div>
